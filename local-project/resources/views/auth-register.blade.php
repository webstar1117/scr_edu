        ...
        <div class="row d-flex">
            ...
            <div class="col-lg-6">
                <div class="card2 card border-0 px-4 py-5">
                    ...
                    <form class="form-horizontal" id="register_form" method='post' action="{{url('auth-register/email')}}">
                        {{ csrf_field() }}
                        ...
                        <div class="row mt-3 px-3 mb-4">
                            <div class="row px-3"> <label class="mb-1">
                                ...
                                </label> <input id="verify_password" type="password" name="password_confirmation" placeholder="Confirm password"> </div>
                        ...
                        <div class="row px-3"> <label class="mb-1">
                                ...
                                <a href="{{url('auth-register/phone')}}" class="ml-auto mb-0 text-sm">Register with phone</a>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#otp_submit").click(function() {
                $.ajax({
                    type: "POST",
                    url: "/auth-register/email/verify-number",
                    data: {
                        "_token": "{{ csrf_token() }}",
                        otp: $('#otp').val(),
            ...
            $("#otp_resend").click(function() {
                $.ajax({
                    type: "POST",
                    url: "/auth-register/email/resend-number",
                    data: {
                        "_token": "{{ csrf_token() }}",
